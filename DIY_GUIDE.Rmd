...
Download the entire repository. It is important to have the trustscore_annotateds.py and trustscore_evaluation.py in the same folder as the .Rmd file to import the trust score functions that are in that Python file.
...
trust_model = trustscore_annotated.TrustScore()
