...
Download the entire repository. It is important to have the trustscore_annotated.py and trustscore_evaluation.py in the same folder as the .Rmd file to import the trust score functions that are in that Python file.
